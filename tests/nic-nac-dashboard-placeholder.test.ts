...
describe('DashboardPlaceholder', () => {
  ...
  it('renders the Sparkle Suite Nic-Nac workspace shell', () => {
    ...
    expect(source).toContain("label: 'Live Lineup'")
    expect(source).not.toContain("label: 'Live Queue'")
  ...
  it('renders the site settings card with profile, copy, and social controls', () => {
    ...
    expect(html).toContain('About narrative')
    expect(html).toContain('Paste the story you want customers to read.')
    ...
    expect(html).toContain('Show Facebook VIP button in the landing hero')
    expect(html).toContain('aria-label="Show Facebook VIP button in the landing hero"')
  ...
  it('renders a plain-English Live Lineup 2.0 setup and verification guide', () => {
    ...
    expect(html).not.toContain('party IDs are selected')
