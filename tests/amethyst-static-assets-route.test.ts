  ...
  it.each([
    ...
    async (assetName, endpoint) => {
      ...
      if (assetName === 'Join.html') {
        expect(html).toContain('src="/amethyst/join-runtime.js?v=20260917-team-lead-photo-v1"')
        expect(html).toContain('href="/amethyst/join.css?v=20260914-team-recruiting-v1"')
