...
describe('public site slug route', () => {
  ...
  it('renders the homepage with slug canonicals and rep-targeted template data', async () => {
    ...
    expect(html).toContain(
      'href="/amethyst/homepage.css?v=20260926-lineup-grouped-v1"',
    )
    expect(html).toContain('src="/amethyst/tweaks-panel.jsx?v=20260725-emerald-garden"')
    expect(html).toContain('src="/amethyst/live-lineup.js?v=20260926-lineup-grouped-v1"')
    expect(html).toContain('src="/amethyst/homepage.jsx?v=20260926-lineup-grouped-v1"')
    expect(html).toContain(
