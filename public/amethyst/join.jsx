    ...
    <header className="hp-header">
      <div className="hp-header-inner">
        ...
        <nav className="hp-header-nav" aria-label="Primary">
          ...
          <a {...linkProps(TRADE_BOARD_HREF)} className="hp-header-link">{isBrittDanceFloorComingSoon ? "Dance Floor · Coming soon" : "Dance Floor"}</a>
      ...
      <div className="hp-footer-inner">
        ...
        <div className="hp-footer-col">
          <ul>
            ...
            <li><a {...linkProps(FOOTER_LINKS.tradeBoard || TRADE_BOARD_HREF)}>{isBrittDanceFloorComingSoon ? "Dance Floor · Coming soon" : "Dance Floor"}</a></li>
